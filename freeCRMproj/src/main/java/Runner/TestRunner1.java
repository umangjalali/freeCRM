...
//@CucumberOptions(features= "src/test/resources/features/ExportCompany.feature",glue= {"StepDefinition"},plugin= {"pretty",
	//"html:JUNITReports/ExportCompany/htmlreport",
	//"json:JUNITReports/ExportCompany/jsonreport.json",
	//"junit:JUNITReports/ExportCompany/xmlreport.xml",
	//"com.cucumber.listener.ExtentCucumberFormatter:JUNITReports/cucumber-reports/ExportCompany/report.html"})
